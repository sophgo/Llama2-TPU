...
编译生成llama2可执行程序，将`llama2`放到/Llama2-TPU/demo目录下，同时按照下列方式指定芯片编号（默认只使用0号芯片）和bmodel路径。
运行`llama2`，默认单芯运行`llama2-7b_int8_1dev.bmodel`:
```shell
